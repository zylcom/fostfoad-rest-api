...
export const UserSchema = z
    ...
    phonenumber: z
        ...
        countryCode: z
            ...
            .max(2, {
            message: "Country code is too long. Country codes are two-letter e.g. IN, DO, NE, SI, AE. See https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2 for more information.",
        })
            .default("ID"),
    }, { invalid_type_error: "Phonenumber must be an object '{ number: string }'.", required_error: "Phonenumber is required." })
        .superRefine((data, ctx) => {
        if (!isValidPhoneNumber(data.number, data.countryCode.toUpperCase())) {
